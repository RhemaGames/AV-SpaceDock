...
var thruster_burst = preload("res://scenes/Ships/Midfield/Catamaran/components/Thuster_particle.tscn")
var target = preload("res://scenes/Ships/Midfield/Catamaran/components/target.tscn")
var version = 0.1
signal died()
signal damaged()
