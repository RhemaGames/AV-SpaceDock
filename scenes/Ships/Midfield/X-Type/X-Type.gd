extends Node3D
var thruster_burst = preload("res://scenes/Ships/Midfield/X-Type/components/Thuster_particle.tscn")
var target = preload("res://scenes/Ships/Midfield/X-Type/components/target.tscn")
var version = 0.1
signal died()
signal damaged()
