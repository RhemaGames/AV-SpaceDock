extends Node3D
var thruster_burst = preload("res://scenes/Ships/Midfield/UglyDuck/components/Thuster_particle.tscn")
var target = preload("res://scenes/Ships/Midfield/UglyDuck/components/target.tscn")
var version = 0.1
signal died()
signal damaged()
