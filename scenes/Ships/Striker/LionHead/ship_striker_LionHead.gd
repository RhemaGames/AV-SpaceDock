...
var thruster_burst = preload("res://scenes/Ships/Striker/LionHead/components/Thuster_particle.tscn")
var target = preload("res://scenes/Ships/Striker/LionHead/components/target.tscn")
var version = 0.1
