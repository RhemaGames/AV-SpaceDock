...
var thruster_burst = preload("res://scenes/Ships/Defender/Waka/components/Thuster_particle.tscn")
var target = preload("res://scenes/Ships/Defender/Waka/components/target.tscn")
var version = 0.1
signal died()
signal damaged()
